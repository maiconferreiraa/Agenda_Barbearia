  ...
  return (
    <div className="flex items-center gap-2 border-b border-ink-border bg-gold/5 px-4 py-2 text-xs text-neutral-300">
      ...
      <button
        ...
        className="rounded-md bg-gold px-2.5 py-1 font-medium text-ink hover:brightness-110 disabled:opacity-50"
      >
        Ativar
      </button>
      <button onClick={dismiss} className="text-neutral-500 hover:text-neutral-300">
        Agora não
      </button>
    </div>
  )
